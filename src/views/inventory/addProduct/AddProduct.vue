<template>
  ...
  <div @click="clickEnDiv" class="flex flex-col items-center p-4  w-full h-full md:h-full">
    ...
    <div class="w-full">
      ...
      <p v-else-if="faltaPresentacionProducto" class="text-red-600">La presentacion del producto es un campo requerido</p>
    </div>
    ...
    <div class="w-full mt-3 border border-gray-500 p-2 rounded-lg">
      ...
      <p v-if="hasprecioDetalle && faltaPrecioDetalle" class="text-red-600 w-full">El precio detalle está activado, espefícica un precio</p>
    ...
    <div class="w-full mt-3 border border-gray-500 p-2 rounded-lg">
      ...
      <input type="text" :disabled="!hasprecioMayorista" id="precioProducto" v-model="precioMayorista"
        ...
        <p v-if="hasprecioMayorista && faltaPrecioMayorista" class="text-red-600 w-full">El precio mayorista está activado, espefícica un precio</p>
    </div>
...
const registrarProductoMetod = () => {
  if (validateForm()) {
    let payload = buildPayload();
    
    try {
      let respuesta = registrarProducto(payload);
    } catch (error) {
