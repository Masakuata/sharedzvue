<template>
    <div>
        ...
        <div class="flex flex-row w-full  bg-bgBlue  rounded-b-lg overflow-hidden">
            <div class="w-1/4 bg-bgGray">
            ...
            <div class="flex flex-col w-3/4">
                ...
                <div class="flex flex-col w-full mt-2">
                    ...
                    <p class="text-white  ml-3 mr-2">{{ tipoCliente }}</p>
                </div>

                <div class="flex flex-row w-full px-3 mb-3 ">
                            ...
                            <div class="flex flex-row items-center">
                                <div class="w-4 mr-3">
                                    <svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        stroke-linejoin="round" class="lucide lucide-map-pinned w-4 text-white">
...
const obtenerTiposCliente = async () => {
    try {
        ...
        response.data.forEach(element => {
            if (element.id === props.cliente.tipoCliente) {
