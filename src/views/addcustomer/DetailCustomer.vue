<template>
    ...
    <h1 class="text-white absolute top-0 right-0 mr-2   text-xl font-semibold text-left mt-3 md:invisible">DETALLE CLIENTE
    </h1>
                        ...
                        <div class="flex flex-col w-8/12  py-3">
                            ...
                            <div class="w-full px-4 md:flex md:flex-row md:justify-end">
                                <button @click="goEditCliente"
                                    class="bg-bgPurple rounded-xl mt-1 text-white w-full md:w-40">Editar</button>
                            </div>
