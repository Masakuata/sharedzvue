            ...
            <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                <div :class="{ 'text-right': isSidebarOpen }" class="md:inline">
                    <button @click="toggleSidebar" type="button"
                        class="text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-300 md:hidden"
                ...
                <ul class="space-y-2 font-medium md:pt-60">
                    <li>
                        <a href="#"  
                        @click="goHome"
                            class="flex items-center p-2 md:px-2 md:py-6 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <a href="#" @click="goAddNote"
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">Agregar nota</span>
                            <span
                    ...
                    <li>
                        <a href="#" @click="goAddCustomer"
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">Agregar cliente</span>
                        </a>
                    </li>
                    <li>
